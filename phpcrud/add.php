...
if (isset($_POST['add'])) {
    ...
    $result = mysqli_query($conn, "INSERT INTO kontak(name,email,mobile,photo) VALUES('$name','$email','$mobile','$filename')");
...
<body>
    <div class="box">
        ...
        <form action="add.php" method="post" name="form1" enctype="multipart/form-data">
            ...
            <div class="add">
                <button class="btn-add" name="add" type="submit">Add</button>
            </div>
        </form>
    </div>
</body>